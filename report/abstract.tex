...
Constructing a high quality threat models and studying their effect on different types of networks can be a very complex process that requires a substantial amount of time and financial founds. In this report the threat models used have been composed by the author and proved that the threats are likely to occur. By applying them to a specific network architecture or applications we try to analyze their effect on centralized and decentralized computer networks.
