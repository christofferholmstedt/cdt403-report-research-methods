...
%
%Constructing high quality threat models and studying their effect on different types of computer networks can be a very complex process that requires a substantial amount of time and financial funds. The threat models used in this paper have been composed by the authors to simulate the possible circumstances that are likely to occur. By applying them on centralised and decentralised computer networks, it is possible to analyze their effect on the specific network architectures or applications.%
