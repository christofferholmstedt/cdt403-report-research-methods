...
Results obtained from these observations will be used to summarise which network architecture is more resistant to a specific threat. 
As a conclusion from our observations, we can say that decentralised systems have shown better results dealing with these threats.
Decentralised systems are more tolerant to infrastructure failures.
Also by keeping the user's data in distributed environment censorship and privacy threats can be easily avoided.
