...
\title{Peer to peer security issues in comparison to centralized security issues\titlenote{Title is work in progress.}}
...
\input{centralised.tex}

\input{peertopeer.tex}
