...
It's also in this area Greschbach et al \cite{greschbach2012} comes to the conclusion that a good technical solution that doesn't give away to much information in metadata is needed.
...
Tightly coupled with trust is also accountablity.
...
The possiblity to be completely anonymous makes it possible for the user that has bad behaviour in the network to act as a new user when the first one has been blocked by a noticeable amount of users.
In the end to introduce accountability to a decentralised system might not what you want to do due to low amount of malicous users \cite{mondal2006}.
